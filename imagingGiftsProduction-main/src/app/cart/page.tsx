...
import TopNavAll from "@/components/Home/TopNavAll";
...
const Cart = () => {
  ...
  cartState.cartArray.map((item) => (totalCart += item.priceDetails.offerPrice * item.quantity));
                        ...
                        >
                          <div className="w-1/2">
                            <div className="flex items-center gap-6">
                              ...
                              <div>
                                <div className="text-title">{product.productName}</div>
                          ...
                          <div className="w-1/12 price flex items-center justify-center">
                            <div className="text-title text-center">
                              ${product.priceDetails.offerPrice}.00
                            </div>
                          </div>
                          ...
                          <div className="w-1/6 flex total-price items-center justify-center">
                            <div className="text-title text-center">
                              ${product.quantity * product.priceDetails.offerPrice}.00
                            </div>
                          </div>
