              ...
              >
                <div className="infor flex items-center gap-5">
                  <div className="bg-img">
                    <Image
                      src={product.thumbImage || "/fallback-image.jpg"} // Provide a fallback
                      width={300}
                      height={300}
                      alt={product.productName || "Default Product"} // Fallback alt text
                  ...
                  <div className="">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      ...
                      <div className="product-origin-price text-title text-secondary2">
                        <del>${product.priceDetails.mrp}.00</del>
                      </div>
                    </div>
                  </div>
                </div>
